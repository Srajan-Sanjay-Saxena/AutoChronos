...
export const getDiskUsage = async () => {
    try {
        ...
        const usedSpace = `${(used / (1024 * 1024 * 1024)).toFixed(2)} GB (${usedPercentage}%)`;
        const freeSpace = `${(free / (1024 * 1024 * 1024)).toFixed(2)} GB (${freePercentage}%)`;
        console.log(`Disk Usage Report for ${path}:`);
        console.log(`Total Space: ${(total / (1024 * 1024 * 1024)).toFixed(2)} GB`);
        console.log(`Used Space: ${(used / (1024 * 1024 * 1024)).toFixed(2)} GB (${usedPercentage}%)`);
        console.log(`Free Space: ${(free / (1024 * 1024 * 1024)).toFixed(2)} GB (${freePercentage}%)`);
